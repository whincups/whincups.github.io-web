    ...
    var a = function() {
        ...
        return a.prototype.init = function() {
            ...
            var a,
                b = this,
                c = [];
            if ("block" == b.settings.navType)
                var d = "skippr-nav-element-block";
        ...
        for (var b = s.State.calls[a][0], c = s.State.calls[a][1], e = s.State.calls[a][2], f = !1, g = 0, h = b.length; h > g; g++) {
            ...
            if ("none" !== e.display || e.loop || v.setPropertyValue(i, "display", e.display), (r.queue(i)[1] === d || !/\.velocityQueueEntryFlag/i.test(r.queue(i)[1])) && r.data(i, l)) {
                ...
                var j,
                    ...
                    m = !1;
                for (var n in k)
                    j = k[n], /^\(0[^.]/.test(r.data(i, l).transformCache[j]) && (m = !0, delete r.data(i, l).transformCache[j]);
    ...
    var v = s.CSS = {
                ...
                for (var f = ["color", "backgroundColor", "borderColor", "borderTopColor", "borderRightColor", "borderBottomColor", "borderLeftColor", "outlineColor"], c = 0, g = f.length; g > c; c++)
                    !function() {
                        ...
                        v.Normalizations.registered[b] = function(c, e, f) {
                            ...
                            case "extract":
                                var g;
                                if (v.RegEx.wrappedValueAlreadyExtracted.test(f))
                                    g = f;
                                else {
                                    var h,
                                        i = {
        ...
        Names: {
            ...
            prefixCheck: function(a) {
                if (s.State.prefixMatches[a])
                    return [s.State.prefixMatches[a], !0];
        ...
        setPropertyValue: function(a, c, d, e, f) {
            ...
            if ("scroll" === c)
                ...
                v.Normalizations.registered[c]("inject", a, d), g = "transform", d = r.data(a, l).transformCache[c];
            else {
                if (v.Hooks.registered[c]) {
                    var h = c,
                        i = v.Hooks.getRoot(c);
        ...
        flushTransformCache: function(a) {
            ...
            for (b in r.data(a, l).transformCache)
                c = r.data(a, l).transformCache[b], "transformPerspective" !== b ? (9 === o && "rotateZ" === b && (b = "rotate"), e += b + c + " ") : d = c;
    ...
    v.Hooks.register(), v.Normalizations.register(), s.animate = function() {
        function a() {
            function a() {
                ...
                function t() {
                    ...
                    for (var k in f)
                        null !== f[k] && v.setPropertyValue(b, k, f[k]);
                ...
                if ("scroll" === A) {
                    ...
                    for (var J in n) {
                        ...
                        if (v.Names.prefixCheck(O)[1] !== !1 || v.Normalizations.registered[O] !== d) {
                            ...
                            s.debug && console.log("Skipping [" + O + "] due to a lack of browser support.")
                    }
                    h.element = b
                }
        ...
        if ("stop" !== n && !r.isPlainObject(p)) {
            ...
            for (var z = y; z < arguments.length; z++)
                !q(arguments[z]) && /^\d/.test(arguments[z]) ? p.duration = parseFloat(arguments[z]) : "string" == typeof arguments[z] ? p.easing = arguments[z] : !q(arguments[z]) || 2 !== arguments[z].length && 4 !== arguments[z].length ? f(arguments[z]) && (p.complete = arguments[z]) : p.easing = arguments[z]
        }
        var A;
        switch (n) {
        case "scroll":
        ...
        if (u)
            k.each(a);
        else if (1 === w && k.nodeType)
            a.call(k);
        else
            for (var F in k)
                k[F].nodeType && a.call(k[F]);
        var G,
        ...
        s.Sequences["slide" + b] = function(a, c) {
            ...
            d.display = "Down" === b ? d.display || "block" : d.display || "none", d.begin = function() {
                ...
                if ("Down" === b) {
                    ...
                    for (var d in e)
                        /^overflow/.test(d) || (e[d] = [s.CSS.getPropertyValue(a, d), 0]);
                    a.style.display = "none"
                } else {
                    c();
                    for (var d in e)
                        e[d] = [0, s.CSS.getPropertyValue(a, d)];
